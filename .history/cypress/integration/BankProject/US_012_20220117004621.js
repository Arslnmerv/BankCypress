...
it('US12-T04 Edit featuresları kullanma', function(){
 ...
 page.getLastName().type('kus')
  ...
  page.getMiddleInitial().clear().type('ak')
  page.getEmail().type('ozgur@gmail.com')
  page.getMobileNumber().type('444-888-8888')
  page.getZipCode().type('3333')
  page.getAddressTextBox().type('konyaaltı')
  page.getCity().type('antalya')
  page.getSsn().type('123-22-5555')
  page.getAccountMenu().select('destek')
